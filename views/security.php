...
<body>
	...
	<div class="container text-center" style="color:white;margin-top:10%;">
		<h1>Security</h1>
		<div><img src="../images/security.jpg" class="img-responsive img-thumbnail"></div>
		<h3>We have 30 cctv cameras in the entire school to take care of students security</h3>
		<h3>A department police is availabe in the campus 24*7</h3>
	</div>
