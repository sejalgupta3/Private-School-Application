...
<body>
	...
	<div class="container text-center" style="color:white;margin-top:10%;">
		<h1>Games</h1>
		<div><img src="../images/ground.jpg" class="img-responsive img-thumbnail"></div>
	</div>
	<div class="container" style="color:white;margin-top:1%;">
		<h2>We encourage students to get involved in sports. We have teams for the following sports:</h2>
		<ul class="list-group" style="color:green;">
		    <li class="list-group-item">Table Tennis</li>
		    <li class="list-group-item">Foot Ball</li>
			<li class="list-group-item">Base Ball</li>
			<li class="list-group-item">Batminton</li>
