...
<body>
	...
	<div class="container text-center" style="color:white;margin-top:10%;">
		<h1>Library</h1>
		<div><img src="../images/library.jpg" class="img-responsive img-thumbnail"></div>
		<h3>Library is open from 10A.M to 6P.M</h3>
		<h3>Students are encouraged to borrow books and develope reading habits.</h3>
	</div>
