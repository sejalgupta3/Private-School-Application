...
<body>
	...
	<div class="container text-center" style="color:white;margin-top:10%;">
		<h1>Class Room</h1>
		<div><img src="../images/class.jpg" class="img-responsive img-thumbnail"></div>
		<h3>We have 30 well equipped class rooms in the school premises.</h3>
		<h3>Capacity for each class is 60 students.</h3>
	</div>
